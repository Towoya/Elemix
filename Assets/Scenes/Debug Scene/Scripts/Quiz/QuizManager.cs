...
public class QuizManager : MonoBehaviour
{
    ...
    public void SetQuizValues(string question, string correctAnswer, string[] choices, GameObject container, string correctMessage, string incorrectMessage, int quizIndex)
    {
